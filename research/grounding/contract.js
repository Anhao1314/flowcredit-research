...
export const selectionPromptVersion='span-selection/v1';
export const interpretationPromptVersion='fact-interpretation-span/v1';
export const selectionInstructions=readFileSync(new URL('../prompts/span-selection-v1.txt',import.meta.url),'utf8');
export const interpretationInstructions=readFileSync(new URL('../prompts/fact-interpretation-span-v1.txt',import.meta.url),'utf8');
...
export function testProvider(responder,{model='scripted-selection',modelVersion='v1'}={}){
